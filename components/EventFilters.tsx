  ...
  return (
    <Popover.Root>
      <Popover.Trigger asChild>
        <button className="relative inline-flex items-center gap-2 rounded-md border border-zinc-300 px-3 py-1.5 text-sm font-medium hover:bg-zinc-100">
      ...
      <Popover.Portal>
        <Popover.Content
          className="w-64 rounded-lg border border-zinc-300 bg-white p-4 shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95"
          sideOffset={5}
          align="start"
        >
          <div className="space-y-4">
                ...
                return (
                  <div key={eventType.value} className="flex items-center gap-3">
                    <Checkbox.Root
                      ...
                      className="flex h-5 w-5 items-center justify-center rounded border border-zinc-300 bg-white data-[state=checked]:border-blue-600 data-[state=checked]:bg-blue-600"
                    >
                      <Checkbox.Indicator>
            ...
            {activeFilterCount > 0 && (
              <button
                ...
                className="w-full rounded-md border border-zinc-300 px-3 py-1.5 text-sm font-medium hover:bg-zinc-100"
              >
                Clear all filters
              </button>
            )}
