...
export const MOCK_EVENTS: CalendarEvent[] = [
  ...
  // Edge case: 15 people with time off from Christmas to New Year's
  {
    ...
    type: 'time-off',
    startTime: utc(2025, 11, 25, 12, 0), // Dec 25 at noon UTC
    endTime: utc(2025, 11, 31, 12, 0), // Dec 31 at noon UTC
    person: 'Sarah Chen',
    isAllDay: true,
  ...
  },
  {
    ...
    title: 'Alex - Out of Office',
    type: 'time-off',
    startTime: utc(2025, 11, 25, 12, 0),
    endTime: utc(2025, 11, 31, 12, 0),
    person: 'Alex Kim',
    isAllDay: true,
    description: 'Holiday vacation',
    timezone: DEFAULT_TIMEZONE,
